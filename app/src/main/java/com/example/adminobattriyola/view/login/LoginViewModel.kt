...
@HiltViewModel
class LoginViewModel @Inject constructor(val repo:LoginRepo, val pref:SharePref):ViewModel() {

//    fun fillOTP(otp:String,
...
//            }
//        }
    fun doLogin(telepon:String,error:MutableState<Boolean>,loading:MutableState<Boolean>,event:()-> Unit) =
        viewModelScope.launch {
            try {
